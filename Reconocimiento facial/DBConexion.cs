...
namespace Reconocimiento_facial
{
    public class DBConexion
    {
        ...
        public DBConexion()
        {
            conn = new OleDbConnection("Provider = Microsoft.Jet.OLEDB.4.0; Data Source = MaycolDB.mdb");
            conn.Open();
        }
        ...
        {
            conn.Open();
            OleDbCommand comm = new OleDbCommand("INSERT INTO RostrosUsuarios (Name,Code,Face) VALUES ('" + Name + "','" + Code + "',?)", conn);           
        ...
        {
            string sql = "SELECT IdImage,Name,Code,Face FROM RostrosUsuarios";
